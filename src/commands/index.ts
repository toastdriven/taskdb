...
export function registerAllCommands(program: Command, output: OutputFn): void {
  ...
  program
    ...
    .action(async (identifier, opts) =>
      updateCommand(program, output, identifier, opts),
    );
  ...
  program
    ...
    .action(async (identifier, opts) =>
      viewCommand(program, output, identifier, opts),
    );
  ...
  program
    ...
    .option("--format <format>", "Output format: quiet | plain | json", "plain")
    .action(async (identifier, opts) =>
      completeCommand(program, output, identifier, opts),
    );
  ...
  program
    ...
    .option("--format <format>", "Output format: quiet | plain | json", "plain")
    .action(async (identifier, opts) =>
      deleteCommand(program, output, identifier, opts),
    );
  ...
  program
    ...
    .option("--format <format>", "Output format: quiet | plain | json", "plain")
    .action(async (identifier, comment, opts) =>
      commentCommand(program, output, identifier, comment, opts),
    );
  ...
  program
    ...
    .description(
      "Full-text search across all tasks (uses rg if available, falls back to grep).",
    )
    .option("--format <format>", "Output format: plain | json", "plain")
